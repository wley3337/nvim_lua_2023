...
local trim_white_space = vim.api.nvim_create_augroup('TrimWhiteSpace', {
    clear = true
})
...
local auto_format_lsp = vim.api.nvim_create_augroup('AutoFormatLsp', {
    clear = true
})
vim.api.nvim_create_autocmd('BufWritePre', {
    callback = function()
