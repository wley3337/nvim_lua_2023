-- Amazing plugin-esk idea written by Dane Harnett that brings up a list of
-- commands for NeoVim that exicutes commands in the vim command line
--
local M = {}
...
function M.init()
    ...
    -- add commands to key map
    vim.keymap.set("n", "<leader>cp", open_command_palette)
end
